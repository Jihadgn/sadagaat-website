    ...
    return (
        <>
            <main >
                ...
                <section className={`py-10 bg-white grid grid-cols-12 lg:px-16 px-1 ${i18n.language === "en" ? "text-left" : "text-right"}`}>
                    <div></div>
                        ...
                        <div className="grid md:grid-cols-2 sm:grid-cols-1 border border-gray-300 lg:p-5 p-1">
                            ...
                            <div className="pt-4 lg:px-5 px-2 col-span-2">
                                ...
                                <input required value={data.name} onChange={(e) => { setData({ ...data, name: e.target.value }) }}
                                    type="text" className={`bg-gray-50 border border-gray-300 text-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 d ${i18n.language === "en" ? "text-left" : "text-right"}`} />
                            </div>
                            <div className="pt-4 lg:px-5 px-2 col-span-2">
                                <div >
                                ...
                                <input required value={data.email} onChange={(e) => { setData({ ...data, email: e.target.value }) }}
                                    type="email" className={`bg-gray-50 border border-gray-300 text-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 d ${i18n.language === "en" ? "text-left" : "text-right"}`} />
                            </div>
                            <div className="pt-4 lg:px-5 px-2 col-span-2">
                                <div >
                                ...
                                <input required value={data.dateOfBirth} onChange={(e) => { setData({ ...data, dateOfBirth: e.target.value }) }}
                                    type="date" className={`bg-gray-50 border border-gray-300 text-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 d ${i18n.language === "en" ? "text-left" : "text-right"}`} />
                            </div>
                            <div className="pt-4 lg:px-5 px-2 col-span-2 md:col-span-1">
                                ...
                                <input required value={data.phoneNumber} onChange={(e) => { setData({ ...data, phoneNumber: e.target.value }) }}
                                    type="text" className={`bg-gray-50 border border-gray-300 text-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 ${i18n.language === "en" ? "text-left" : "text-right"}`} />
                            </div>
                            <div className="pt-4 lg:px-5 px-2 col-span-2 md:col-span-1">
                                <div >
                            ...
                            <div className="pt-4 lg:px-5 px-2 col-span-2 md:col-span-1">
                                ...
                                <select required value={data.gender} onChange={(e) => { setData({ ...data, gender: e.target.value }) }}
                                    className={`bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5  ${i18n.language === "en" ? "text-left" : "text-right"}`}>
                                ...
                                <div className={` ${i18n.language === "en" ? "text-left" : "text-right"}`}>
                                    {i18n.language === "en" ? (
                                        <div className=" px-1">
                                            ...
                                            <label for="checkbox-1" className="ms-2 mx-3 text-md text-gray-900">{t("Yes")}</label>
                                        </div>
                                    )
                                        :
                                        (
                                    ...
                                    {i18n.language === "en" ? (
                                        <div className=" px-1">
                                            <input value={data.liveInSudan} onChange={(e) => { setData({ ...data, liveInSudan: "true" }) }}
                                                id="country-option-1" type="radio" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300" />
                                            <label for="checkbox-2" className="ms-2 mx-3 text-md text-gray-900">{t("No")} </label>
                                        </div>
                                    )
                                        :
                                        (
                                    ...
                                    {i18n.language === "en" ? (
                                        <div className=" px-1">
                                            <input value={data.heardAboutSadagaat} onChange={(e) => { setData({ ...data, heardAboutSadagaat: "social_media" }) }}
                                                id="country-option-1" type="radio" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300" />
                                            <label for="checkbox-1" className="ms-2 mx-3 text-md text-gray-900">{t("Social Media")} </label>
                                        </div>
                                    )
                                        :
                                        (
                                    ...
                                    {i18n.language === "en" ? (
                                        <div className=" px-1">
                                            <input value={data.heardAboutSadagaat} onChange={(e) => { setData({ ...data, heardAboutSadagaat: "Friends_or_Family" }) }}
                                                id="country-option-1" type="radio" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300" />
                                            <label for="checkbox-2" className="ms-2 mx-3 text-md text-gray-900">{t("Friends")} </label>
                                        </div>
                                    )
                                        :
                                        (
                                    ...
                                    {i18n.language === "en" ? (
                                        <div className=" px-1">
                                            <input value={data.volunteerTime} onChange={(e) => { setData({ ...data, volunteerTime: "morning" }) }}
                                                id="country-option-1" type="radio" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300" />
                                            <label for="checkbox-1" className="ms-2 mx-3 text-md text-gray-900">{t("Morning time")}</label>
                                        </div>
                                    )
                                        :
                                        (
                                    ...
                                    {i18n.language === "en" ? (
                                        <div className=" px-1">
                                            <input value={data.volunteerTime} onChange={(e) => { setData({ ...data, volunteerTime: "evening" }) }}
                                                id="country-option-1" type="radio" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300" />
                                            <label for="checkbox-2" className="ms-2 mx-3 text-md text-gray-900">{t("Evening time")}</label>
                                        </div>
                                    )
                                        :
                                        (
