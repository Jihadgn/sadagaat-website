        ...
        <>
            <main >
                ...
                <section className="py-10 bg-white grid grid-cols-12 px-6">
                    <div></div>
                    <div className="col-span-10 grid md:grid-cols-5 sm:grid-cols-1 text-gray-800 px-16 gap-6 pb-10">
                        {/* contact */}
                        <div className="grid grid-cols-2 gap-3 col-span-3 mx-5 pb-16    ">
                            ...
                            <div className="bg-gray-100 grid grid-cols-4 p-5">
                                <div><svg class="w-12 h-12 text-blue-600 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
