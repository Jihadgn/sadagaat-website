    ...
    <>
      <main>
        ...
        <section className="px-4 top">
          <div className="block grid xl:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 justify-center">
            <div className="flex justify-center px-10 pl-10 pr-10 gap-4 pt-5">
              <a className="text-center hover:text-gray-500" href={contact.facebook ?? "https://web.facebook.com/Sadagaat/?_rdc=1&_rdr"} target="blank">
              ...
              <a className="text-center hover:text-gray-500" href={contact.twitter ?? "http://twitter.com/sadagaat"} target="blank">
                <svg className="w-5 h-5  text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a className="text-center hover:text-gray-500" href={contact.linkedin ?? "http://www.linkedin.com/pub/sadagaat-sudan/54/431/5b7"} target="blank">
                <svg className="w-5 h-5  text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M12.51 8.796v1.697a3.738 3.738 0 0 1 3.288-1.684c3.455 0 4.202 2.16 4.202 4.97V19.5h-3.2v-5.072c0-1.21-.244-2.766-2.128-2.766-1.827 0-2.139 1.317-2.139 2.676V19.5h-3.19V8.796h3.168ZM7.2 6.106a1.61 1.61 0 0 1-.988 1.483 1.595 1.595 0 0 1-1.743-.348A1.607 1.607 0 0 1 5.6 4.5a1.601 1.601 0 0 1 1.6 1.606Z" clipRule="evenodd" />
                  <path d="M7.2 8.809H4V19.5h3.2V8.809Z" />
                </svg>
              </a>
              <a className="text-center hover:text-gray-500" href={contact.youtube ?? "https://www.youtube.com/channel/UCRSvaVpv6Hw6eUnI6OsutSQ"} target="blank">
                <svg className="w-5 h-5  text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a className="text-center hover:text-gray-500" href={contact.instagram ?? "https://www.instagram.com/sadagaat_organization/"} target="blank">
                <svg class="w-5 h-5 text-white   dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd" />
                </svg>

              </a>
              <a className="text-center hover:text-gray-500 " href={contact.tiktok ?? "http://www.tiktok.com/@sadagaatsudan"} target="blank">
                <svg className="w-5 h-5  text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill-rule="evenodd" d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"></path></svg>
              </a>
              <a className="text-center hover:text-gray-500 " href={contact.soundcloud ?? "https://soundcloud.com/sadagaat"} target="blank">
            ...
            <div className="flex justify-center sm:pt-4 gap-4">
              <h6 className="text-md text-white flex gap-2 text-center">
                ...
                {`+${contact.phone ?? "44884060063"}`} </h6>
              <h6 className="text-md text-white flex gap-2 text-center  ">
                <svg className="w-5 h-5  text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" strokeLinecap="round" strokeWidth="2" d="m3.5 5.5 7.893 6.036a1 1 0 0 0 1.214 0L20.5 5.5M4 19h16a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z" />
                </svg>
                {contact.email ?? "info@sadagaat-uk.org"}</h6>
            </div>
                ...
                <div className="relative w-full justify-center">
                  <form action="" onSubmit={redirectSearchPage}>
                    ...
                    <Link
                      ...
                      className="absolute rounded-full top-2.5 end-0 px-2 text-sm font-medium h-auto bg-white text-gray-900">
