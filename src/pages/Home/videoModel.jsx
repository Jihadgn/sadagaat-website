      ...
      <main className="overflow-hidden">
        ...
        <a onClick={this.openModal} className="modal-btn">
          <div className="pt-10 pb-10 grid grid-cols-9 justify-content-center " >
            ...
            <svg className="cursor-pointer w-24 h-24 p-3 col-span-1 rounded-full border-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
