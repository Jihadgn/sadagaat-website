            ...
            <main>
                ...
                <Navbar fluid rounded>
                    ...
                    <Navbar.Collapse className="text-gray-800 gap-4 flex-wrap overflow-hidden">
                        ...
                        <Navbar.Link href="/" className="text-gray-700 flex font-bold text-md mt-6"> {t("Home")}</Navbar.Link>
                        ...
                        <Dropdown
                            label= {t("featured ongoin projects")} inline className="text-gray-800 text-md">
